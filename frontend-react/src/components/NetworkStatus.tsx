...
export default function NetworkStatus() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/80 backdrop-blur-md overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center p-10 bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl animate-in slide-in-from-bottom-10 fade-in duration-500 max-w-md text-center">
        
        {/* Animated Icon */}
        <div className="relative flex items-center justify-center w-28 h-28 mb-6">
          <div className="absolute inset-0 bg-rose-500/20 rounded-full animate-ping opacity-75"></div>
          <div className="absolute bg-slate-800 rounded-full w-24 h-24 flex items-center justify-center border border-slate-700 shadow-inner z-10">
        ...
        <button 
          onClick={handleRetry}
          disabled={isRetrying}
          className="flex items-center space-x-2 bg-emerald-600 hover:bg-emerald-500 disabled:bg-slate-700 disabled:text-slate-500 text-white px-8 py-3 rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] disabled:shadow-none"
        >
