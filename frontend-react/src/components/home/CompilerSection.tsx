...
export default function CompilerSection() {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 w-full z-10 relative bg-surface dark:bg-background overflow-x-hidden">
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Features List */}
          <div className="space-y-6 lg:space-y-8 order-2 lg:order-1 lg:col-span-4">
            {[
              {
          ...
          <div className="order-1 lg:order-2 lg:col-span-8 w-full">
            <div className="relative group w-full rounded-2xl md:rounded-3xl lg:rounded-[2rem] overflow-hidden border-2 border-border/50 shadow-2xl bg-white dark:bg-slate-900">
        ...
        <div className="mt-16 w-full flex justify-center">
          <motion.button
            ...
            className="inline-flex items-center space-x-2 bg-primary hover:bg-primary/90 text-text-inverse font-bold text-base md:text-lg px-8 md:px-10 py-4 md:py-5 rounded-xl border border-primary/20 transition-all shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/50"
          >
